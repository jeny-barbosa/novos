...
$html .= '</tbody>';
$html .= '</table';
$html .= "------ <p style='color:blue;'>Foram encontrados " . mysqli_num_rows($resultado_trasacoes) . " Usuários distintos!</p> <br>";
...
$dompdf->load_html('
			<h1 style="text-align: center;">BookFree - Relatório Geral de Usuários</h1>
			' . $html . '
		');
