...
<body> 
    <h1 align="center">Relatórios Usuários - BookFree </h1> <br>
    ...
    <table class=" table-striped table-bordered" align="center"> 
        ...
        <tr>
            ...
            <td align="center"><br><a href="usuarioRelatorioPDF.php" target="_blank" class="btn btn-lg btn-danger"> <span class="glyphicon glyphicon-user"></span></a> <br></td>
            <td align="center" ><br><a href="usuarioRelatorioXLS.php" target="_blank" class="btn btn-lg btn-success"><span class="glyphicon glyphicon-user"></span></a><br></td>      
        </tr>
