...
<body> 
    <h1 align="center">Relatórios Pedidos - BookFree </h1> <br>
    <div class="container" style="width:600px;">
        <table class=" table-striped table-bordered" align="center"> 
            ...
            <tr>
                ...
                <td align="center"><br><a href="pedidoRelatorioPDF.php" target="_blank" class="btn btn-lg btn-danger"> <span class="glyphicon glyphicon-user"></span></a> <br></td>
                <td align="center" ><br><a href="pedidoRelatorioXLS.php" target="_blank" class="btn btn-lg btn-success"><span class="glyphicon glyphicon-user"></span></a><br></td>      
            </tr>
