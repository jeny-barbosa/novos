...
$query = "SELECT * FROM pedidos WHERE 1 = 1 %s %s %s ORDER BY codigo ASC LIMIT 10 OFFSET $iOffset";
...
<html>
    ...
    <body>
                ...
                <div align="right">
                    ...
                    <div align="left">
                        <form method="POST" id="form-pesquisa" action="" class="form-inline">
                            ...
                            <button type="submit" class="btn  btn-primary" name="enviar" value="Pesquisar"  size="10">Pesquisar</button>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                            <button align="left" type="button" name="add" id="add" data-toggle="modal" data-target="#add_data_Modal" class="btn btn-warning">Adicionar <span class="glyphicon glyphicon-plus"></span> </button> 
                        </form>
                    </div>
                    <br/>
        ...
        <div align="center">
            <a href="pedidos.php" class="btn btn-default <?= ($iPagina == 1) ? 'btn-lg btn-primary' : '' ?>"> 1</a>
            <a href="pedidos.php?pagina=2" class="btn btn-default <?= ($iPagina == 2) ? 'btn-lg btn-primary' : '' ?> disabled"> 2 </a>
